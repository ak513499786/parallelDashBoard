...
export default function Dashboard() {
  return (
    <>
      <Navbar />
      <main className="px-[60px] pb-[31px] pt-[42px] flex gap-[20px]">
        <div className="w-[58.61%]">
          <section className="pt-[27.96px] pb-[28px] pl-[25.1px] pr-[27.46px] bg-white">
            <h1 className="text-[20px] leading-[26px] font-bold">
              Continue Learning
            </h1>
            <div className="pl-[3.9px] pt-[33.04px] flex gap-[19px]">
              <div className="w-[44.855%] h-[209px] bg-[#F7F7F7]"></div>
              <div className="flex w-[51.362%] gap-[22px] flex-col">
                <div className="flex gap-[11px] flex-col">
                  ...
                  <h1 className="h-[68.4px] text-[24px] leading-[29.04px] pr-[0.77px]">
                ...
                <div className="py-[0.85px] flex justify-between">
                  <button className="h-[43.07px] w-[140px] bg-black text-white rounded-[6px] text-[17.95px] leading-[21.54px]">
                    Resume{" "}
                  </button>{" "}
          ...
          <section className="mt-[24.62px] h-[659px] bg-white">
            <div className="pt-[30px] pb-[23px] pl-[25.1px] pr-[43px] border-b-[1px] flex justify-between">
        ...
        <div className="w-[41.4%]">
          <section className="w-[100%] py-[22.5px] flex justify-between pl-[24px] pr-[26px] h-[77px] bg-white">
            <div className="flex gap-[9px]">
              <Image src="/whatsapp.svg" width={26.53} height={26.67} />
              <p className="text-[16px] leading-[20.8px] py-[5.5px] font-bold capitalize">
          ...
          <section className="w-[100%] mt-[22px] h-[445px] bg-white">
            ...
            <div className={style.zoom}>
              <div className="border-b-[1px] h-[82px] flex justify-between items-center">
                <div className="w-[261px]">
                  <p className="text-[16px] leading-[20.8px]">
                    07th April <span className="ml-[17px]">09:30PM</span>
                  </p>
                  <h1 className="text-[20px] leading-[26px] mt-[11px]">
          ...
          <section className="w-[100%] mt-[22px] h-[314px] bg-white">
            ...
            <div className={style.rank}>
              <div className="border-t-[1px] h-[44px] pr-[30px] pl-[27px] flex justify-between items-center">
              ...
              <div className="h-[62px] flex justify-between sticky pl-[26.45px] pr-[30.17px] bg-[#DEEBFE] w-[100%] bottom-0 items-center">
                <div className="flex items-center gap-[18px]">
                ...
                <div className="flex gap-[5px] h-[26px]">
                  <Image
                    ...
                    height={24.37}
                  />
                  <p className="text-[20px] leading-[26px]">10,560 pts</p>
                </div>{" "}
              </div>
            </div>
          </section>

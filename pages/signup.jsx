  ...
  return (
    <main className="flex">
      <div className="w-[595px] max-sm:w-full max-md:px-[40px] max-sm:px-[20px] max-md:w-full bg-[white] h-[100vh] flex flex-col justify-between pl-[40px] pb-[52.16px] pt-[130px] pr-[113px]">
        <div className="flex w-[502.43px] max-sm:w-full flex-col gap-[50px]">
          ...
          <div className="flex flex-col relative gap-[32px]">
            ...
            <input
              ...
              className={
                passwordEntered
                  ? "pl-[25.71px] max-sm:w-full w-[421px] text-[#D21313] border-[1px] border-[#D21313] rounded-[6px] pt-[21.5px] pb-[16.5px] text-base"
                  : "pl-[25.71px] max-sm:w-full w-[421px] border-[1px] border-black rounded-[6px] pt-[21.5px] pb-[16.5px] text-base"
              }
            />
            {visible ? (
              <Image
            ...
            <div className="flex w-[421px] max-sm:w-full flex-col gap-[16px]">
      ...
      <div className="h-[100vh] max-sm:hidden w-full relative overflow-hidden">
        <Image
          src="/bg-eclips.svg"

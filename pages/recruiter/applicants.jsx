...
export default function Jobs() {
  ...
  const [applicant, setapplicant] = useState("Frontend Developer");
  ...
  return (
    <>
      ...
      <main className="px-[59.5px] pt-[41.36px] max-md:px-[40px] pb-[50px] max-sm:px-[20px]">
        ...
        <div className="my-[23px] bg-white pl-[19.08px] mx-[0.5px] max-hamburger:flex-col max-hamburger:items-start relative pt-[15px] pb-[14px] max-md:px-[20px] max-sm:px-[15px] pr-[22.92px] rounded-[6px] flex gap-[16px] max-sm:gap-[8px] items-center justify-between">
          <div className="flex gap-[24px] max-md:gap-[8px] max-sm:flex-col max-hamburger:justify-between max-hamburger:w-full items-center">
            <Image
              src="/drop.svg"
              className={
                isOpen11
            ...
            />
            <div
              onClick={() => toggleMenu(setIsOpen11, isOpen11)}
              className="pl-[15.71px] max-sm:w-full w-[278px] max-lg:w-[198px] h-[48px] bg-white cursor-pointer w-full border-[1px] border-black rounded-[6px] flex items-center max-smallerphone:text-base text-[14px] leading-[16.8px]"
            >
              <p className=" max-sm:w-[95%]">
                {applicant || "Frontend Developer"}
              </p>
            </div>{" "}
            {isOpen11 && (
            ...
            <div className="flex gap-[16px] max-sm:gap-[8px] max-smallphone:flex-wrap max-sm:w-full">
              <button
                onClick={handleshortlisted}
                className={
                  shortlisted
                    ? "h-[37px] max-smallphone:text-sm capitalize max-sm:w-full w-[180px] max-sm:w-[170px] bg-[white] text-black border-[1px] border-black rounded-[6px] text-[14px] leading-[16.8px]"
                    : "h-[37px] max-smallphone:text-sm capitalize max-sm:w-full w-[180px] max-sm:w-[170px] bg-[black] text-white border-[1px] border-black rounded-[6px] text-[14px] leading-[16.8px]"
                }
              >
                Applicants (12)
              </button>{" "}
              <button
                ...
                className={
                  shortlisted
                    ? "h-[37px] max-smallphone:text-sm capitalize max-sm:w-full w-[130px] bg-[black] text-white border-[1px] border-black rounded-[6px] text-[14px] leading-[16.8px]"
                    : "h-[37px] max-smallphone:text-sm capitalize max-sm:w-full w-[130px] bg-[white] text-black border-[1px] border-black rounded-[6px] text-[14px] leading-[16.8px]"
                }
              >
                Shortlisted (10){" "}
              </button>{" "}
          ...
          <Image
            src="/search.svg"
            className="cursor-pointer max-sm:right-[24px] max-sm:left-auto max-sm:top-[128px] max-smallphone:top-[175px] max-hamburger:left-[300px] max-hamburger:top-[92px] max-sm:top-[72px] absolute right-[36.92px]"
            width={24}
            height={24}
          />
        </div>
        ...
        {shortlisted ? (
          <div className="flex gap-[20px]">
            ...
            ></div>
            <div
              className={viewshortlistedprofile ? style.candidates : "hidden"}
            >
              <Image
                src="/close.svg"
            ...
            {applicant === "Data Analyst" ? (
              <section className="flex justify-center pt-[62px] pb-[94.63px] w-full">
                <div className="w-[467.34px] flex flex-col max-sm:h-auto items-center h-[439.37px] relative rounded-[18px] border-[1px] border-[#00000033] py-[26px] max-sm:px-[15px] px-[35px]">
                  ...
                  Your job doesn’t have any Applicants                  </h1>
                  <p className="mt-[12px] mb-[29px] text-[16px] text-center leading-[19.2px] text-black opacity-70">
                  All the your applicants will appear here                  </p>
                  <button
                    onClick={() => sethelp("add job")}
                    className="h-[43px] w-[238px] flex capitalize justify-center items-center gap-[4px] max-smallphone:w-full max-sm:w-[170px] bg-black text-white rounded-[6px] text-[14px] leading-[16.8px]"
                  >
                    <Image
                      src="/plus.svg"

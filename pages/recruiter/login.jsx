...
export default function Login() {
  ...
  return (
    <main>
      <div className="w-[598px] max-md:w-full max-md:px-[40px] max-sm:px-[20px] relative bg-[white] h-[100vh] flex flex-col justify-between pl-[60px] pb-[48.07px] pt-[77px] pr-[113px]">
        {signUp && (
          <>
            <div className="flex flex-col gap-[81px]">
              ...
              <div className="flex flex-col gap-[28px]">
                <div
                  className={
                    validateemail
                      ? "hidden text-[#D41717] bg-white left-[78px] max-md:left-[40px] px-[5px] text-[11.91px] leading-[14.29px] top-[121px]"
                      : "absolute text-[#D41717] bg-white left-[78px] max-md:left-[60px] max-sm:left-[30px] px-[5px] text-[11.91px] leading-[14.29px] top-[182px]"
                  }
                >
                ...
                <input
                  ...
                  placeholder={validateemail ? "Company Email" : ""}
                  className={
                    validateemail
        ...
        {signUp == false && (
          <div className="flex flex-col gap-[50px]">
            ...
            <div className="flex flex-col relative gap-[24px]">
              <strong className="ml-[8px] w-[63px] h-[20px] cursor-pointer border-b-[2px] border-black">
                Go back
              </strong>
              <strong
